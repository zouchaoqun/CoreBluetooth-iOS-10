...
@property (strong, nonatomic) NSArray *segueIds;
...
- (void)viewDidLoad {
    ...
    self.segueIds = @[@"ShowScanTest"];
    self.menuNames = @[@"Scan test"];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [self performSegueWithIdentifier:self.segueIds[indexPath.row] sender:self];
}
